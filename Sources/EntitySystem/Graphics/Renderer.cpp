...
namespace Graphics
{
	...
	void Renderer::DrawVertexArray(VertexArray* vertexArray,Shader* shader,glm::mat4 modelMatrix)
	{
		shader->Use();
	...
	void Renderer::SetTexture(TextureSP texture)
	{
		texture->Use();
	}
	void Renderer::DrawMesh(Mesh* mesh,glm::mat4 modelMatrix)
	{
		auto shader = mesh->UseShader();
